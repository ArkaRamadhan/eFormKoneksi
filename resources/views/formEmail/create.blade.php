        ...
        <div class="space-y-12" style="padding-bottom: 3rem">
            <x-card>
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-400">Data pribadi pemohon</p>
                    <fieldset style="margin-top: 2rem;">
                        <legend class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-400" >Jenis Permohonan
                        </legend>
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="flex items-center gap-x-3">
                                <input id="pendaftaran" name="pendaftran" type="radio"
                                    value="Pengaktifan"
                            ...
                            <div class="flex items-center gap-x-3">
                                <input id="pendafatran" name="pendaftaran" type="radio"
                                    value="Penghapusan"
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <select id="countries"
                            ...
                            <option value="Customer Service"
                                {{ old('jabatan') == 'Customer Service' ? 'selected' : '' }}>Customer Service</option>
                            <option value="Marketing" {{ old('jabatan') == 'Marketing' ? 'selected' : '' }}>Marketing
                            </option>
                            <option value="Staf/Back Office"
                                {{ old('jabatan') == 'Staf/Back Office' ? 'selected' : '' }}>Staf/Back Office</option>
                            <option value="Supervisor" {{ old('jabatan') == 'Supervisor' ? 'selected' : '' }}>Supervisor
                            </option>
                            <option value="Pimpinan KK" {{ old('jabatan') == 'Pimpinan KK' ? 'selected' : '' }}>Pimpinan
                                KK</option>
                            ...
                            <option value="Pimpinan Cabang"
                                {{ old('jabatan') == 'Pimpinan  Cabang' ? 'selected' : '' }}>Pimpinan Cabang</option>
                        </select>
                        <x-input-error :messages="$errors->get('cabang')" class="mt-2" />
                    </div>
            ...
            <x-card>
                ...
                <div class="col-span-full">
                    <x-input-label class="text-base font-semibold leading-7 text-gray-900 dark:text-white" for="alasan"
                        :value="('Alasan')" />
                    <textarea id="alasan" name="alasan" rows="3"
                        class="mt-3 block w-full border-1 py-1.5 border-gray-300 dark:border-gray-700  dark:bg-gray-900 dark:text-gray-300 focus:border-sky-500 dark:focus:border-sky-600 focus:ring-sky-500 dark:focus:ring-sky-600 rounded-md shadow-sm" placeholder="Masukan Alasan Anda">{{ old('alasan') }}</textarea>
